...
(function() {
  var Fs, Logger, Net, Nvim, PORT, Path, Plugin, Reflect, Vm, _, argv, attach, await, callHandler, clib, coffee, commands, dataHandler, defer, defineCommand, evalMethod, fiber, getSpecs, lib, log, nvimSocket, onNvimDisconnect, onNvimNotification, onNvimRequest, sock, stdio, sync, vmHandler,
    slice = [].slice;
