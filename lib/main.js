...
(function() {
  var Fs, Logger, Net, Nvim, PORT, Path, Reflect, Vm, _, argv, attach, await, coffee, dataHandler, defer, evalHandler, evalMethod, fiber, handlers, lib, log, nvimSocket, onNvimNotification, onNvimRequest, sock, stdio, sync, vmHandler,
    slice = [].slice;
  ...
  handlers['RunBuffer'] = function(nr) {
  ...
  fiber(function() {
    ...
    lib = require('./nvim');
    evalMethod = evalHandler;
    return Nvim.command("com! RunBuffer call rpcnotify(" + Nvim._channel_id + ", 'RunBuffer', bufnr('%'))");
  });
